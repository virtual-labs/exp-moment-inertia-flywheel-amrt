  ...
  return {
    ...
    link: function (scope, element, attrs) {
      ...
      stage = new createjs.Stage(
        "demoCanvas",
      ); /** Initialization of stage element */
      ...
      weight_container =
        new createjs.Container(); /** Creating new container to keep weights and weight holder together */
      weight_container.name =
        "weight_container"; /** Assigning name to container */
      stage.addChild(weight_container); /** Adding container to stage */
      weight_container_temp =
        new createjs.Container(); /** Creating new container to keep weights together while the weights falls from fly wheel */
      ...
      function handleComplete() {
        /** Loading all preloaded images to canvas */
        loadImages(
          queue.getResult("texture"),
          "texture",
          318,
          130,
          "",
        ...
        loadImages(
          queue.getResult("light_gradient"),
          "light_gradient",
          327,
          130,
          "",
        ...
        loadImages(
          queue.getResult("weight_with_hook"),
          "weight_with_hook",
          369,
          553,
          "",
        ...
        loadImages(
          queue.getResult("thread_falling_anim"),
          "thread_falling_anim",
          298,
          230,
          "",
        ...
        setText(
          ...
          2,
          container,
        ); /** Text for place value ten in counter */
        setText(
          "ten",
          142,
          231,
        ...
        setText(
          ...
          2,
          container,
        ); /** Text for place value one in counter */
        setText(
          "period",
          186,
          231,
        ...
        setText(
          ...
          2,
          container,
        ); /** Text for place value one after decimal point in counter */
        setText(
          "decimal_ten",
          223,
          231,
          ...
          2,
          container,
        ); /** Text for place value ten after decimal point in counter */
        setText("height_txt", 485, 629, "02cm", "black", 1.1, container);
        initialisationOfVariables(); /** Initializing the variables */
        initialisationOfControls(
          scope,
        ); /** Initialization of control side variables */
        thread_anim_rect.graphics
          .beginStroke("")
          .drawRect(
            320,
            200,
            180,
            490,
          ); /** Rectangle for mask thread animation */
        ...
        createStopwatch(
          ...
          500,
          1,
        ); /** To load and generate stop watch */
        stage.update(); /** Function to update stage */
        setTimeout(function () {
          clearInterval(tick);
        }, 200); /** Clearing stage update after 200 milli seconds */
        play_event = clockContainer
          .getChildByName("play")
          .on("click", function () {
            /** Click event added to play button on timer */
            releaseHold(
              scope,
            ); /** Function to start the experiment and rotation of fly wheel */
            scope.$apply();
          });
        clockContainer
          ...
          .off(
            "click",
            listner_pause,
          ); /** Click event removed from pause button */
        clockContainer.getChildByName("reset").on("click", function () {
          /** Click event added to reset button on timer */
...
function setText(name, textX, textY, value, color, fontSize, container) {
  var text = new createjs.Text(
    value,
    +fontSize + "em Tahoma, Geneva, sans-serif",
    color,
  );
  text.x = textX;
  text.y = textY;
...
function initialisationOfVariables() {
  ...
  rotation_speed = wheel_rotation_speed =
    33600 / 4; /** Initially speed rate of fly wheel in milli seconds */
  ...
  wound =
    new createjs.Shape(); /** Shape object to create wound over axl of fly wheel */
...
function initialisationOfImages() {
  ...
  stage.getChildByName("weights").x =
    366.5; /** Initial horizontal postion of weights */
  stage.getChildByName("weights").y =
    600; /** Initial vertical postion of weights */
  stage.getChildByName("weights").alpha =
    0; /** Initial visibility of weights */
}
